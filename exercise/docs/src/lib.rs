...
//!and is commonly used for cultivars of Cucurbita argyrosperma, Cucurbita ficifolia, Cucurbita
...
//!!["pumpkins in a field"](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
impl Pumpkin {
    ///If you smash the pumpkin, it can't be used for pie.😭
    pub fn smash(self) {}
}
